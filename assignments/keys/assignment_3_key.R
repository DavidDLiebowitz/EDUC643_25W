...
### Last update: 3/4/25
### Inputs: nerds.csv
### Purpose: load in data, summarize categorical data, fit regression model w/ categorical predictors and produce results
#######################################################################################################
...
datasummary_skim(nerds2, 
                 type="categorical",
                 histogram=F,
                 output = "assignments/keys/assignment_3_descriptives.docx")

## 1.2 Create violin chart descriptive comparisons
...
ggsave("assignments/keys/assignment_3_descr_level.png")
...
ggsave("assignments/keys/assignment_3_descr_locale.png")
...
modelsummary(fit2, 
             ...
             output = "assignments/keys/assignment_3_level.docx")
...
modelsummary(list(fit3, fit4),
             ...
             notes=c("Cells report coefficients and heteroscedastic-robust standard errors in parentheses. Each observation is one school."),
             output = "assignments/keys/assignment_3_highschool.docx")
...
modelsummary(list(fit5, fit6), 
             ...
             output = "assignments/keys/assignment_3_MR.docx")
